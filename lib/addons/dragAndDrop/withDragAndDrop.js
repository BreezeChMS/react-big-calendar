  ...
  var DragAndDropCalendar =
    ...
    (function(_React$Component) {
      ...
      function DragAndDropCalendar() {
        ...
        _this.handlePreviewMove = function(preview) {
          _this.props.onEventDrop(preview)
        }
        ...
        _this.components = (0, _common.mergeComponents)(components, {
          ...
          weekWrapper: function weekWrapper(props) {
            return _react.default.createElement(
              _WeekWrapper.default,
              (0, _extends2.default)({}, props, {
                handlePreviewMove: _this.handlePreviewMove,
              })
            )
          },
        })
